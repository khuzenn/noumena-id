...
class Keluh_Kasih extends CI_Controller {
	 ...
	 */
     ...
     public function __construct()
     {
		...
		$this->load->model('Keluh_kasih_model');
     }

	 public function detail ($id_artikel) {
		$this->data['url'] = site_url('keluh-kasih');

		$detail_artikel = $this->Keluh_kasih_model->getDetailArtikel(decrypt_url($id_artikel));
        ...
        $this->load->view('keluh-kasih/detail', $this->data);
	...
	public function load_more()
    {
        ...
        $articles = $this->Keluh_kasih_model->getMoreArtikelKeluhKasih($limit, $offset);
        ...
        $this->load->view('keluh-kasih/load_more', $this->data);
    }
     ...
     public function index()
	{
		...
		$this->data['list_artikel'] = $this->Keluh_kasih_model->getArtikelKeluhKasih($limit);
		...
		$this->load->view('template/header');
        $this->load->view('template/nav');
        $this->load->view('keluh-kasih/views', $this->data);
        $this->load->view('template/footer');
	}
}
