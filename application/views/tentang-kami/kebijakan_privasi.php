<body>
    <div class="footer-container">
        <h1 class="pt-80">Kebijakan Privasi</h1>
        <p>
        Website nomena.id dimiliki oleh Nomena.id, yang akan menjadi pengontrol atas data pribadi Anda.
        Kami telah mengadopsi Kebijakan Privasi ini untuk menjelaskan bagaimana kami memproses informasi yang dikumpulkan oleh nomena.id, yang juga menjelaskan alasan mengapa kami perlu mengumpulkan data pribadi tertentu tentang Anda. Oleh karena itu, Anda harus membaca Kebijakan Privasi ini sebelum menggunakan website nomena.id.
        ...
        <h4 class="pt-12">Link ke website lain:</h4>
        <p class="pt-10">
        ...
        <h4 class="pt-12">Keamanan informasi:</h4>
        <p class="pt-10">
        ...
        <h4 class="pt-12">Pengungkapan hukum:</h4>
        <p class="pt-10">
        ...
        <h4 class="pt-12">Informasi kontak:</h4>
        <p class="pt-10">
        Jika Anda ingin menghubungi kami untuk mempelajari Kebijakan ini lebih lanjut atau menanyakan masalah apa pun yang berkaitan dengan hak perorangan dan Informasi pribadi Anda, Anda dapat mengirim email ke <a href="mailto:denoumenon@gmail.com."><strong>denoumenon@gmail.com.</strong></a>
        </p>
    </div>
</body>